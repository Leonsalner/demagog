...
The recommended final direction remains:

1. light mode default
2. larger onboarding
3. 1 text step + 3 default videos
4. optional add-to-db step

If scope changes later, update this document rather than scattering onboarding decisions across multiple notes.
