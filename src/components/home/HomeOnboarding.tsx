      ...
      {isOpen ? (
        <ViewportPortal>
          ...
          >
            ...
            >
              {isMobile ? (
                <div className="sticky top-0 z-30 flex items-center justify-end border-b border-slate-200/80 bg-white/94 px-3 py-3 backdrop-blur sm:px-4 dark:border-slate-800/80 dark:bg-slate-950/92">
                  <button
                    type="button"
                    onClick={() => closeOnboarding("dismissed")}
