      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700/60 dark:bg-slate-900">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Link
            href="/add"
            prefetch={false}
            className="inline-flex items-center justify-center rounded-full bg-[#e03e1a] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#c73414] dark:bg-[#ff3300] dark:hover:bg-[#e63a00]"
          >
            Pridať nový výrok
          </Link>
        </div>
